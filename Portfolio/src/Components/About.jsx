                ...
                <div className="rounded-xl p-8 border-white bg-black/50 border hover:- translate-y-1 transistion-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="rounded-xl p-6 hover:-translate-y-1 transistion-all border-white border">
                            <h3 className="text-xl text-[#81E7AF] font-bold mb-4 ">FrontEnd</h3>
                            <div className="flex flex-wrap gap-2">
                                {frontendSkills.map((skill, index) => (
                                    <span key={index} className="bg-[#A1E3F9] text-[#6889A6] px-3 py-1 rounded-full text-sm">{skill}</span>
                                ))}
                            </div>
                        </div>
                        <div className="rounded-xl p-6 hover:-translate-y-1 transistion-all border-white border">
                            <h3 className="text-xl  text-[#81E7AF]  font-bold mb-4 ">BackEnd</h3>
                            <div className="flex flex-wrap gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        ...
                        <div className="p-6 rounded-xl border-white border hover:- translate-y-1 transistion-all">
                            <h3 className="text-xl font-bold mb-4 text-[#81E7AF]">Work Experience</h3>
